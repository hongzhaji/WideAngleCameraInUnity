...
Java_com_ty_cameraplugin_CameraPluginActivity_nativeInit(JNIEnv *env, jobject obj)
{
	gCallbackObject = env->NewGlobalRef(obj);
}

extern "C" JNIEXPORT void JNICALL
Java_com_ty_cameraplugin_CameraPluginActivity_nativeRelease(JNIEnv *env, jobject obj)
{
